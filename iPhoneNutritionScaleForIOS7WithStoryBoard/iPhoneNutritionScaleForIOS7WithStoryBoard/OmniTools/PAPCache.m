...
- (void)setAttributesForPhoto:(PFObject *)photo likers:(NSArray *)likers commenters:(NSArray *)commenters likedByCurrentUser:(BOOL)likedByCurrentUser {
    int likersInt = [[NSString stringWithFormat:@"%ld", (long)[likers count]] intValue];
    int commentersInt = [[NSString stringWithFormat:@"%ld", (long)[commenters count]] intValue];
    NSDictionary *attributes = [NSDictionary dictionaryWithObjectsAndKeys:
                                      [NSNumber numberWithBool:likedByCurrentUser],kPAPPhotoAttributesIsLikedByCurrentUserKey,
                                      [NSNumber numberWithInt:likersInt],kPAPPhotoAttributesLikeCountKey,
                                      likers,kPAPPhotoAttributesLikersKey,
                                      [NSNumber numberWithInt:commentersInt],kPAPPhotoAttributesCommentCountKey,
