...
-(void)updateButtonImageForRoll:(CGFloat)roll pitch:(CGFloat)pitch
{
    ...
    CGContextRef imageContext = CGBitmapContextCreate(&data, kKnobSize.width, kKnobSize.height, bitsPerComponent, bytesPerRow, colourSpace, (enum CGBitmapInfo)alphaInfo);
