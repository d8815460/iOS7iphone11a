//
//  NutritionAnalyzerViewController.m
//  iPhoneNutritionScaleForIOS7WithStoryBoard
//
//  Created by 駿逸 陳 on 13/10/18.
//  Copyright (c) 2013年 Proch Technology. All rights reserved.
//

#import "NutritionAnalyzerViewController.h"

@interface NutritionAnalyzerViewController ()
{
    Boolean scaleIsOpen;
}
@end

@implementation NutritionAnalyzerViewController
...
//        NSLog(@" save = %.0f /n dont Save = %.0f ", selectedIngredient.weight, _didntSaveIngredientWeight);
    }
