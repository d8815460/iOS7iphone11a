//
//  NutritionAnalyzerViewController.h
...
@interface NutritionAnalyzerViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, BLEUIProtocol>
...
@property (strong, nonatomic) IBOutlet UITableView *nutrientTabel;
