...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes:[NSDictionary dictionaryWithObject:LabelFont forKey:NSFontAttributeName]];
     */
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    ...
    CGSize detailsLabelSize = [detailsLabel.text sizeWithAttributes:[NSDictionary dictionaryWithObject:nameLabelFont forKey:NSFontAttributeName]];
    */
