...
- (UIImage *)_toolbarBackgroundImage{
    ...
    CGContextDrawLinearGradient(ctx, gradient, CGPointMake(0, 0), CGPointMake(0, 44), kCGImageAlphaNoneSkipFirst);
...
- (void)viewWillLayoutSubviews{
    ...
    self.toolbar.frame = CGRectMake(0, CGRectGetHeight(self.view.frame) - 44, 320, 44);
}
